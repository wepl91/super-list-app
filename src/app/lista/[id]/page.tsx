              ...
              {isOwner && list.sharedMembers && list.sharedMembers.length > 0 && (
                ...
                >
                  <svg
                    ...
                    aria-hidden="true"
                  >
                    <path d="M3.478 2.404a.75.75 0 0 0-.926.941l2.432 7.905H13.5a.75.75 0 0 1 0 1.5H4.984l-2.432 7.905a.75.75 0 0 0 .926.94 60.519 60.519 0 0 0 16.458-9.06 1.2 1.2 0 0 0 0-1.738A60.515 60.515 0 0 0 3.478 2.404Z" />
                  </svg>
                  <span
                    role="tooltip"
