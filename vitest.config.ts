...
"src/lib/haptics.ts",
        ...
        "src/lib/gestures.ts",
        "src/lib/itemsOrder.ts",
        "src/lib/listIdentity.ts",
        "src/lib/useHydrated.ts",
        "src/lib/theme.tsx",
        "src/lib/useScreenWakeLock.ts",
        "src/lib/productNames.ts",
        "src/lib/pantrySelectors.ts",
        "src/lib/stores/preferencesStore.ts",
        "src/lib/stores/pantryStore.ts",
        "src/hooks/useItemSwipe.ts",
        "src/components/ConfirmDialog.tsx",
        "src/components/CreateListDialog.tsx",
        "src/components/ListIdentityEditor.tsx",
        "src/components/ListItemRow.tsx",
        "src/components/ListItemSortable.tsx",
        "src/components/ListFilterChips.tsx",
        "src/components/AddItemForm.tsx",
        "src/components/PantryChips.tsx",
        "src/components/PantryEditor.tsx",
